...
export default class {
  ...
  async #setPage() {
    if (!this.routeObj.route.page) {
      this.#data.pageRoute = "'404'"
      return
    }
  ...
  async render(layout) {
    ...
    if (this.routeObj.pathArray[0] in this.#page)
      this.#data.pageMethod = this.routeObj.pathArray.shift()
    ...
    await this.#page[this.#data.pageMethod]({
      params: this.routeObj.pathArray,
      query: this.routeObj.query,
    })
  }
