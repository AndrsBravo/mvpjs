...
export default class EndPoint {
  ...
  get endPointObject() { return this.#endpointObj; }
...
*/
    ...
    if (this.#requestInit.method == "POST") {
      this.#params = ["POST"];
      this.#endpointObj.param = this.#params;
      this.#fetchFunctionName = "post";
      this.#fetchUrl = this.#endpointObj.url;
      this.#setFetchUrl(); return;
    }
    if (this.#requestInit.method == "PUT") {
      this.#params = ["PUT"];
      this.#endpointObj.param = this.#params;
      this.#fetchFunctionName = "put";
      this.#fetchUrl = this.#endpointObj.url;
      this.#setFetchUrl(); return;
    }
