...
export class Presenter {
  ...
  get ids() {
    if (!this.#propertyIdsCollection)
      this.#propertyIdsCollection = new PropertyIdsCollection(this)
  ...
  get sections() {
    if (!this.#propertyCollectionSections)
      this.#propertyCollectionSections = new PropertySectionCollection(this)
  ...
  get models() {
    if (!this.#propertyModelCollection)
      this.#propertyModelCollection = new PropertyModelCollection()
